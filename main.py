...
# image = cv.imread('dataset/daun_jeruk/003.jpg')
# cv.imshow('jeruk', rescale(cv.imread('dataset/daun_jeruk/003.jpg')))
# cv.waitKey(0)
# ########################################################## open image berupa array
# print(cv.imread('dataset/daun_jeruk/003.jpg'))
...
for img in images :
    ...
    im_name = "dataset/daun_seledri_kontras/" + str(i) + ".png"
...
for img in images :
    ...
    im_name1 = "dataset/daun_seledri_gyroscale/" + str(i) + ".png"
...
for img in images :
    ...
    im_name2 = "dataset/daun_seledri_edge/" + str(i) + ".png"
